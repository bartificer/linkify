 ...
 * @returns {boolean} - `true` if the value can be used to instantiate a `urijs` instance that defines a protocol and hostname, `false` otherwise.
 * @see {@link module:urijs}
 */
export function isURL(url){ // function generated by Lumo AI - checked against URI.js API docs
    try {
        // can be parsed
        const uri = new URI(url);
        // has a protocol & hostname
